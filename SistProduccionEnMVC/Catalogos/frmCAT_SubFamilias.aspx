<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCAT_SubFamilias.aspx.cs" Inherits="SistProduccionEnMVC.Catalogos.frmCAT_SubFamilias" %>
...
<body style="background-color:black; height: 634px;">
    ...
    <div style="width: auto; background-color: #000000; margin-right: 34px; margin-left: 34px; margin-top: 15px; margin-bottom: 15px;" class="container">
            <div>
                <label style="font-size: 72px; color: #FFFFFF; font-family: 'Segoe UI'; margin-right:30px">familia</label><br />
                &nbsp;<input type="text" style="height: 45px; width: 138px; font-size:72px"/>
                &nbsp;<input type="text" style="height: 45px; width: 536px; font-size:72px"/>
            </div>
            <div>
                <label style="font-size: 72px; color: #FFFFFF; font-family: 'Segoe UI'; margin-right:30px">Sub Familia</label><br />
                &nbsp;<input type="text" style="height: 45px; width: 138px; font-size:72px"/>
